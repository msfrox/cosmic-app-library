...
impl<'a, Message: Clone + 'static> ApplicationButton<'a, Message> {
    ...
    pub fn new(
        ...
        // Long names are ellipsized by the text widget below instead of being
        // hard-truncated here (upstream #235/#335), so the full name is kept
        // and just gets the source suffix appended.
